...
export const translations: Record<"ar" | "fr", TranslationSet> = {
  ar: {
    ...
    importPanelTitle: "استيراد البيانات (KML، GPX، DXF، GeoJSON، CSV، EXCEL)",
    importHelpLine1: "اسحب وأسقط ملفات الرفع هنا أو انقر للاستيراد",
  ...
  fr: {
    ...
    importPanelTitle: "Importation de données (KML, GPX, DXF, GeoJSON, CSV, EXCEL)",
    importHelpLine1: "Glissez-déposez des fichiers de levé ou cliquez pour importer",
